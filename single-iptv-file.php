...
$iptv_type      = get_post_meta($post_id, '_singlo_iptv_type', true);
$iptv_format    = get_post_meta($post_id, '_singlo_iptv_format', true);
$iptv_category  = get_post_meta($post_id, '_singlo_iptv_category', true);
$size           = get_post_meta($post_id, '_singlo_iptv_size', true);
$downloads      = get_post_meta($post_id, '_singlo_iptv_downloads', true);
...
if (empty($iptv_type)) $iptv_type = 'N/A';
if (empty($iptv_format)) $iptv_format = 'M3U';
if (empty($iptv_category)) $iptv_category = 'IPTV Codes';
                                        ...
                                        <div class="l8YSdd">
                                            <div class="w7Iutd">
                                                ...
                                                <div class="wVqUob">
                                                    ...
                                                    <?php endif; ?>
                                                    <div class="g1rdde">
                                                        <svg width="16" height="16" style="margin-right:6px; vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false" role="img" aria-label="Format icon">
                                ...
                                <div ssk="8:ZnF4ie-0">
                                    ...
                                    <section class="HcyOxe">
                                        <header class=" cswwxf">
                                            <div class="VMq4uf">
                                                <div class="EaMWib">
                                                    <h2 class="XfZNbf">IPTV File Info</h2>
                                                </div>
                                            </div>
                                        </header>
                                            ...
                                            <table itemscope="" itemtype="https://schema.org/SoftwareApplication">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo esc_html($iptv_type); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <strong>
                                                        ...
                                                        <td><?php echo esc_html($iptv_format); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <strong>
                                                        ...
                                                        <td><?php echo esc_html($iptv_category); ?></td>
                                                    </tr>
